...
function theme.set_highlights(options)
	...
	hl(0, "Keyword", { fg = palette.red, bg = "NONE" })
	hl(0, "Statement", { fg = palette.cyan, bg = "NONE", italic = options.italics })
	...
	hl(0, "@keyword.operator", { fg = palette.red, bg = "NONE" })
	...
	hl(0, "@punctuation.accessor.javascript", { link = "Delimiter" })
